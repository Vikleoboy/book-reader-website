  ...
  return (
    <main className=" bg-neutral-200/80 flex flex-col justify-center items-center pt-16 sm:pt-24 relative">
      <Image
        ...
        alt="book icon"
        quality={100}
        className="max-small:w-[35px]"
      />
      <p className="text-black  leading-relaxed text-xl sm:text-2xl lg:text-3xl mt-2 sm:mt-3 lg:mt-4">
        Axiom Books
      </p>
      ...
      <div className="hero-reverse flex flex-col justify-center items-center ">
        <p className="text-lg small:text-xl sm:text-2xl largesceen:text-3xl text-center text-gray-800 font-normal leading-normal w-[85%] sm:w-[70%] lg:w-[60%] largesceen:w-[38vw] mt-5 sm:mt-10">
          Axiom Books offers a comprehensive library of your favorite reads and
          exciting new discoveries—all in one convenient platform. Browse our
          curated selection to find your next favorite book, track your reading
          journey, and set personal reading goals effortlessly.
        </p>
        ...
        <Image
          ...
          placeholder="blur"
          quality={100}
          className="w-[80%] md:mt-14 desktop:mt-20 rounded-t-3xl"
        />
      </div>
    </main>
  );
