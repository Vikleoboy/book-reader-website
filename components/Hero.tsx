...
const Hero = () => {
  return (
    <main className="bg-gray-100 flex flex-col justify-center items-center pt-24 relative">
      <Image src={iconBook} alt="book icon" quality={100} />
      <p className="text-black  leading-relaxed text-lg font-semibold">Axiom Books</p>
      <h1 className="text-7xl lg:w-[60vw] text-center font-bold lg:leading-[80px] pt-1">Read, discover, set goals. All in one place.</h1>
