    ...
    <main className=" bg-neutral-200/60 flex flex-col justify-center items-center pt-16 sm:pt-24 relative">
      ...
      <div className="hero-reverse flex flex-col justify-center items-center ">
        <p className="text-lg small:text-xl sm:text-2xl text-center text-gray-800 font-normal leading-normal w-[85%] sm:w-[70%] lg:w-[60%] largesceen:w-[38vw] mt-5 sm:mt-10">
          Axiom Books is the single destination for all the books you love — and all the ones you’ll love next. Browse the Book Store to find the perfect book to read. Track what you’ve read and want
          to read, and set your own Reading Goals — all in one app and across all your Apple devices.
        </p>
        <Image src={library1} alt="library page review" placeholder="blur" quality={100} className="w-[80%] lg:mt-14 desktop:mt-20 rounded-t-3xl" />
      </div>
    </main>
  );
};
